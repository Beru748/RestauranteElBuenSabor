public class Imprimir {
    ...
    public static void mostrarPedido() {
        ...
        while (i < Datos.nombresPlatos.length) {
            if (Datos.cant[i] > 0) {
                ...
                System.out.printf("%-20s x%-6d $%,.0f%n", Datos.nombresPlatos[i], Datos.cant[i], (Datos.p[i] * Datos.cant[i]));
                // suma al subtotal
    ...
    public static void imprimirFacturaCompleta() {
        ...
        while (j < Datos.nombresPlatos.length) {
            if (Datos.cant[j] > 0) {
                System.out.printf("%-20s x%-6d $%,.0f%n", Datos.nombresPlatos[j], Datos.cant[j], (Datos.p[j] * Datos.cant[j]));
            }
            j++;
        } // fin while
        System.out.println("----------------------------------------");
